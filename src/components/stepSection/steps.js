...
export default function Steps () {
    const ActiveSteps = [
        {
            title: ['Realiseer', <br key={'step1'}/>, 'verandering'],
        ...
        {
            title: ['Realiseer', <br key={'step2'}/>, 'verandering'],
            desc: 'Tijdens het strategisch voortraject ontwikkelen we samen de richting van je merk, oftewel waar sta je en waar wil je naar toe?',
    ...
    let index = 0;
    return (
       <div className="w-full md:-mt-[80px]  lg:-mt-[0px] flex flex-col gap-[32px] pb-[56px] pt-[32px]   xl:gap-[80px] lg:mb-[160px] xl:py-[96px] items-center justify-top xl:h-[744px] bg-sec">
